...
urlpatterns = [
    ...
    path("timelapse/start/<str:timelapse_id>/", views.timelapse_start, name="timelapse_start"),
    path("timelapse/stop/<str:timelapse_id>/", views.timelapse_stop, name="timelapse_stop"),
